...
- Content scripts must execute automatically. If content.js defines a helper such as replaceImages(), initialize it at top level or on DOMContentLoaded, and use a MutationObserver when the target page can add matching elements dynamically.
